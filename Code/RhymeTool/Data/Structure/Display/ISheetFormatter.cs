...
public interface ISheetFormatter
{
	...
	int SpaceBefore(SheetLine line, SheetDisplayLineBuilder lineBuilder, SheetDisplayElement element);
}
...
public record DefaultSheetFormatter : ISheetFormatter
{
	...
	public int SpaceBefore(SheetLine line, SheetDisplayLineBuilder lineBuilder, SheetDisplayElement element)
	{
		if (lineBuilder.CurrentLength > 0 && element is SheetDisplayChord)
		{
			if (line is SheetChordLine)
				return SpaceBetweenChordsOnChordLine;
			else if (line is SheetCompositeLine)
